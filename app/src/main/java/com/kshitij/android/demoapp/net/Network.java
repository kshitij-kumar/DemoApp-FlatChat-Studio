...
public class Network {
	 ...
	 * 
	 * @param context
	 *            Context in which App is running.
	 * @return True if connected, false otherwise.
	 */

	public static boolean isNetworkAvailable(Context context) {
		Log.d(TAG, "isNetworkAvailable(), Checking network connectivity");
	...
	/**
	 * Connects to server using URL class. Downloads data as InputStream and
	 * converts into String representation.
	 * 
	 * @param destUrl
